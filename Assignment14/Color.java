...
public class Color {
    ...
    public String toString() {
        int [][] col = {WHITE,LIGHT_GRAY,GRAY,DARK_GRAY,BLACK,RED,PINK,ORANGE,YELLOW,MAGENTA,CYAN,BLUE};
        String [] colNames = {"WHITE","LIGHT_GRAY","GRAY","DARK_GRAY","BLACK","RED","PINK","ORANGE","YELLOW","MAGENTA","CYAN","BLUE"};

        for (int i = 0; i < col.length; i++) {
            if (Arrays.equals(col[i],rgb)){
                return colNames[i].toLowerCase();
            }
        }
        return "n/a";
    }
